...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', default='data/Text_Recog/Text_Recog_train', help='path to training dataset')
    ...
    """ Data processing """
    parser.add_argument('--select_data', type=str, default='result',
